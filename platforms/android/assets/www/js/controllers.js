...
.controller('PrevisaoCtrl', function($scope, $http) {



    // $http.get("/js/cidades.xml").success(function (data) {
    //         var x2jsCidades = new X2JS();
    //         var listaCidadesJson = x2jsCidades.xml_str2json(data);
    //         $scope.listaCidades = listaCidadesJson;
    //         console.log(listaCidadesJson.cidadeId);
    //         console.log(angular.fromJson($scope.listaCidades));
    //     });
  ...
  $scope.listaCidades = [
    { text: "Cascavel", cidadeId: "4104808" },
    { text: "Curitiba", cidadeId: "4106902" },
    { text: "Foz do Iguaçu", cidadeId: "4108304" },
    { text: "Maringá", cidadeId: "4115200" }
  ];
...
$scope.listaEstacao = [
    { text: "Cascavel", estacaoId: "http://www.simepar.br/site/imagens/graficos_condicoes/24535333.png" },
    { text: "Curitiba", estacaoId: "http://www.simepar.br/site/imagens/graficos_condicoes/25264916.png" },
    { text: "Foz do Iguaçu", estacaoId: "http://www.simepar.br/site/imagens/graficos_condicoes/25245437.png" },
    { text: "Toledo", estacaoId: "http://www.simepar.br/site/imagens/graficos_condicoes/24475343.png" },
    { text: "Maringá", estacaoId: "http://www.simepar.br/site/imagens/graficos_condicoes/23275159.png" }
  ];
